...
> 這裡保留原始論文數據，並額外記錄本次重現結果。兩者代表不同實驗設定：前者是論文原始報告，後者是此 repo 依照目前訓練協議（100 epoch、算力妥協版本/實驗記錄）實際跑出的結果。

| 資料集 | 論文 Top-1 | 本次重現 Top-1 (100 epoch) | 論文 Params | 本次 Params |
|---|---:|---:|---:|---:|
| PlantVillage | 99.88% | 99.72% | 23.04M | 19.88M |
| cassava | 84.29% | 77.73% | 23.04M | 19.84M |
| tomato | 99.99% | 98.77% | 23.04M | 19.85M |

註：本次重現結果來自實際 log / summary：
